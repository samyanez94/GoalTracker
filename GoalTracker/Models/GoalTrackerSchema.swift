...
enum GoalTrackerSchemaV1: VersionedSchema {
	...
	static var models: [any PersistentModel.Type] { [Goal.self, Tag.self] }
}
...
enum GoalTrackerMigrationPlan: SchemaMigrationPlan {
	static var schemas: [any VersionedSchema.Type] { [GoalTrackerSchemaV1.self] }
...
enum GoalTrackerModelContainer {
	@MainActor static func make(isStoredInMemoryOnly: Bool = false) throws -> ModelContainer {
